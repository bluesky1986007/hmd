...
public class Front_CalculationHebiPostTest extends BaseTest {
...
//		logger.info("env="+env);
	...
	@Test(enabled = true,dataProvider = "" + "testData",description="P1_PC交易_下单_计算可获得河币数量",timeOut=300000)
	public void calculationHebi(Map<String, String> datadriven)throws Exception {
		...
		String url = null;
		if("fat".equals(env)){
			url = "https://b2b.fat.homedo.com/shopping/api/calculationHebi";
		}else {
			url = "https://b2b.homedo.com/shopping/api/calculationHebi";
