...
public class Front_MyHebiGetTest extends BaseTest {
...
//		logger.info("env="+env);
	...
	@Test(enabled = true,dataProvider = "" + "testData",description="P1_PC交易_下单_我的河币",timeOut=300000)
	public void myHebi(Map<String, String> datadriven)throws Exception {
		...
		String url = null;
		if("fat".equals(env)){
			url = "https://b2b.fat.homedo.com/shopping/api/myHebi";
		}else {
			url = "https://b2b.homedo.com/shopping/api/myHebi";
