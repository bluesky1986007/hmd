...
public class Front_GetOrderInfoGetTest extends BaseTest {
...
//		logger.info("env="+env);
	...
	@Test(enabled = true,dataProvider = "" + "testData",description="P1_PC交易_下单_获取订单详情",timeOut=300000)
	public void getOrderInfo(Map<String, String> datadriven)throws Exception {
		...
		if("fat".equals(env)){
			url = "https://b2b.fat.homedo.com/shopping/api/getOrderInfo?orderIds="+orderIds;
		}else {
			url = "https://b2b.homedo.com/shopping/api/getOrderInfo?orderIds="+orderIds;
