...
public class Front_GetMemberInvoiceInfoGetTest extends BaseTest {
...
//		logger.info("env="+env);
	...
	@Test(enabled = true,dataProvider = "" + "testData",description="P1_PC交易_下单_获取发票信息",timeOut=300000)
	public void getMemberInvoiceInfo(Map<String, String> datadriven)throws Exception {
		...
		String url = null;
		if("fat".equals(env)){
			url = "https://b2b.fat.homedo.com/shopping/api/getMemberInvoiceInfo";
		}else {
			url = "https://b2b.homedo.com/shopping/api/getMemberInvoiceInfo";
