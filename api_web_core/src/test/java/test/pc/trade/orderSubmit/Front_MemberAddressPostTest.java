...
public class Front_MemberAddressPostTest extends BaseTest {
...
//		logger.info("env="+env);
	...
	@Test(enabled = true,dataProvider = "" + "testData",description="P1_PC交易_下单_获取收货地址",timeOut=300000)
	public void memberAddress(Map<String, String> datadriven)throws Exception {
		...
		String url = null;
		if("fat".equals(env)){
			url = "https://b2b.fat.homedo.com/shopping/api/memberAddress";
		}else {
			url = "https://b2b.homedo.com/shopping/api/memberAddress";
...
//		String dataType = "application/json";
		...
		JSONObject resp = httpClientService.doPostWithCookieOfJSONObject(url,"","",cookie);
