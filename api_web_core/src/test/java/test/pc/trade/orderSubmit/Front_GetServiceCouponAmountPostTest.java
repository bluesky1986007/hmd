...
public class Front_GetServiceCouponAmountPostTest extends BaseTest {
...
//		logger.info("env="+env);
	...
	@Test(enabled = true,dataProvider = "" + "testData",description="P1_PC交易_下单_服务券抵扣",timeOut=300000)
	public void getServiceCouponAmount(Map<String, String> datadriven)throws Exception {
		...
		String url = null;
		if("fat".equals(env)){
			url = "https://b2b.fat.homedo.com/shopping/api/getServiceCouponAmount";
		}else {
			url = "https://b2b.homedo.com/shopping/api/getServiceCouponAmount";
		...
		String data = "{\"zbCategory\":[],\"zbProducts\":[{\"count\":"+ count +",\"serviceId\":"+ serviceId +"}],\"id\":\""+ id +"\"}";
